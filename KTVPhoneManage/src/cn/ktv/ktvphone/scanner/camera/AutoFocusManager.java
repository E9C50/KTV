...
import cn.ktv.ktvphone.scanner.common.Runnable;
import cn.ktv.ktvphone.scanner.config.Config;

/**
 * 鐢变簬瀵圭劍涓嶆槸涓�娆℃�у畬鎴愮殑浠诲姟锛堟墜鎶栵級锛岃�岀郴缁熸彁渚涚殑瀵圭劍浠呮湁Camera.autoFocus()鏂规硶锛�
 * 鍥犳闇�瑕佷竴涓嚎绋嬫潵涓嶆柇璋冪敤Camera.autoFocus()鐩村埌鐢ㄦ埛婊℃剰鎸変笅蹇棬涓烘
 */
