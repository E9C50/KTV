...
public class TypeListActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Spinner spinner = (Spinner) findViewById(R.id.spiType);
	...
	public void BlindSongInfo(ListView listView) {
		Spinner searchText = (Spinner) findViewById(R.id.spiType);
		String message = null;
		if(searchText.getSelectedItem().equals("全部类型")){
			message = "Song-3-";
		}else{
			message = "Song-6-" + searchText.getSelectedItem();
		}
