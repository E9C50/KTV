...
{
    public partial class FrmSongedList : Form
    {
        public FrmSongedList()
        {
            InitializeComponent();
        }
       ...
       public string SearchType = "";
        ...
        public void Search()
        {
            ...
            List<SongInfo> songList = songmanage.GetSongList(this.SearchType, this.SearchgText);
        ...
        private void pnlSongList_Click(object sender, EventArgs e)
        {
            ...
            FrmSongedList.phone = FrmSongedList.phone;
        ...
        private void pnlNextSong_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < PlayList.Songgroup.Count; i++)
            {
                ...
                item.SubItems.Add(PlayList.Songgroup[i].SGI_SongSinger1);
                this.lvSongList.Items.Add(item);
            }
        }
        /// <summary>
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void FrmSongedList_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                for (int i = 0; i < PlayList.Songgroup.Count; i++)
                {
                    ListViewItem item = new ListViewItem();
                    item.Text = PlayList.Songgroup[i].SGI_SongName1;
                    item.Tag = PlayList.Songgroup[i].SGI_SongId1;
                    item.SubItems.Add(PlayList.Songgroup[i].SGI_SongSinger1);
                    this.lvSongList.Items.Add(item);
                }
            }
