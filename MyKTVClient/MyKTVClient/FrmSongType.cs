...
namespace MyKTVClient
{
    public partial class FrmSongType : Form
    {
        ...
        private void pnlSongList_Click(object sender, EventArgs e)
        {
            ...
            FrmSongedList.play = FrmSongType.play;
            FrmSongedList.phone = FrmSongType.phone;
        ...
        public void Search(string type)
        {
            ...
            List<SongInfo> songList = songmanage.GetSongList("类型", type);
        ...
        private void pnHot_Click(object sender, EventArgs e)
        {
            Search("热门流行");
        }

        private void pnSutra_Click(object sender, EventArgs e)
        {
            Search("经典老歌");
        }

        private void pnGame_Click(object sender, EventArgs e)
        {
            Search("游戏动漫");
        }

        private void pnBrigade_Click(object sender, EventArgs e)
        {
            Search("军旅之歌");
        }
        ...
        private void pnChidren_Click(object sender, EventArgs e)
        {
            Search("儿童歌谣");
        }
        /// <summary>
